...
class SubmissionController extends Controller
{
    ...
    **********************************************************************************************/
    ...
    public function postNewSubmission(Request $request, SubmissionManager $service)
    {
        ...
        if($service->createSubmission($request->only(['url', 'prompt_id', 'comments', 'slug', 'character_rewardable_type', 'character_rewardable_id', 'character_rewardable_quantity',  'rewardable_type', 'rewardable_id', 'quantity', 'stack_id', 'stack_quantity', 'currency_id', 'currency_quantity', 'character_is_focus', 'criterion_id', 'criterion']), Auth::user())) {
