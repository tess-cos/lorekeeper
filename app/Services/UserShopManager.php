    ...
    */
    ...
    public function buyStock($data, $user)
    {
        ...
        try {
            ...
            if(!(new CurrencyManager)->creditCurrency(null, $shop->user, 'Market Sale', 'Sold a '.$shopStock->item->displayName.' in '.$shop->displayName, $shopStock->currency, $total_cost)) throw new \Exception("Failed to credit currency.");   
