                ...
                <div class="col-md-10">
                    ...
                    <div class="character-details hide">
                        ...
                        <div class="form-group mb-2">
                            {!! Form::label('Type') !!}
                            {!! Form::select('sale_type[]', ['flatsale' => 'Flatsale', 'auction' => 'Auction', 'ota' => 'OTA', 'xta' => 'XTA', 'raffle' => 'Raffle', 'flaffle' => 'Flaffle', 'pwyw' => 'Pay What You Want'], null, ['class' => 'form-control character-sale-type', 'placeholder' => 'Select Sale Type']) !!}
                        </div>
