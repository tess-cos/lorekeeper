...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Gear Categories' => 'admin/gear/gear-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/gear/gear-categories/edit/'.$category->id : 'admin/gear/gear-categories/create']) !!}
...
{!! Form::open(['url' => $category->id ? 'admin/gear/gear-categories/edit/'.$category->id : 'admin/gear/gear-categories/create', 'files' => true]) !!}
...
$( document ).ready(function() {    
    $('.delete-category-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/gear/gear-categories/delete') }}/{{ $category->id }}", 'Delete Category');
    });
});
