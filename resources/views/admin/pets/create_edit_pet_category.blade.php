...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Pet Categories' => 'admin/data/pet-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/pet-categories/edit/'.$category->id : 'admin/data/pet-categories/create']) !!}
...
<div class="form-group">
        ...
        {!! Form::label('can_user_sell', 'Can Be Sold In User Shops', ['class' => 'form-check-label ml-3']) !!} {!! add_help('This will allow or disallow users to sell pets in their user shops.') !!}
    </div>
