...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Skill Categories' => 'admin/data/skill-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/skill-categories/edit/'.$category->id : 'admin/data/skill-categories/create']) !!}
...
<div class="card mb-3">
    <div class="card-body">
        @include('world._item_category_entry', ['imageUrl' => $category->categoryImageUrl, 'name' => $category->displayName, 'description' => $category->description, 'category'=>$category])
    </div>
</div>
@endif
