...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Figure Categories' => 'admin/world/figure-categories', ($category->id ? 'Edit' : 'Create').' Figure Category' => $category->id ? 'admin/world/figure-categories/edit/'.$category->id : 'admin/world/figure-categories/create']) !!}
...
<div class="form-group">
    ...
    @endif
    {!! Form::label('Thumbnail Image (Optional)') !!} {!! add_help('This thumbnail is used on the figure category index.') !!}
...
<div class="form-group">
    ...
    @endif
    {!! Form::label('Figure Category Image (Optional)') !!} {!! add_help('This image is used on the figure category page as a header.') !!}
    <div>{!! Form::file('image') !!}</div>
    <div class="text-muted">Recommended size: None (Choose a standard size for all figure category header images.)</div>
