...
@section('admin-title') Event Categories @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Event Categories' => 'admin/world/event-categories', ($category->id ? 'Edit' : 'Create').' Event Category' => $category->id ? 'admin/world/event-categories/edit/'.$category->id : 'admin/world/event-categories/create']) !!}
