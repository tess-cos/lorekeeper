...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Concept Categories' => 'admin/world/concept-categories', ($category->id ? 'Edit' : 'Create').' Concept Category' => $category->id ? 'admin/world/concept-categories/edit/'.$category->id : 'admin/world/concept-categories/create']) !!}
...
{!! Form::open(['url' => $category->id ? 'admin/world/concept-categories/edit/'.$category->id : 'admin/world/concept-categories/create', 'files' => true]) !!}
...
<div class="form-group">
    ...
    @endif
    {!! Form::label('Thumbnail Image (Optional)') !!} {!! add_help('This thumbnail is used on the concept category index.') !!}
...
<div class="form-group">
    ...
    @endif
    {!! Form::label('Concept Category Image (Optional)') !!} {!! add_help('This image is used on the concept category page as a header.') !!}
    <div>{!! Form::file('image') !!}</div>
    <div class="text-muted">Recommended size: None (Choose a standard size for all concept category header images.)</div>
...
$( document ).ready(function() {
    $('.delete-category-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/world/concept-categories/delete') }}/{{ $category->id }}", 'Delete Concept Category');
    });
    $('.selectize').selectize();
});
