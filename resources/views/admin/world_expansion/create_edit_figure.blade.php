...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-0">
            {!! Form::label('faction_id', 'Faction (Optional)') !!} {!! add_help('This will set the figure as a member of this faction. To associate this figure with a faction without being a part of it, edit the faction instead. Changing this will remove this figure from any special ranks in their existing faction.') !!}
