...
@section('admin-title') Prompt Categories @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Prompt Categories' => 'admin/data/prompt-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/prompt-categories/edit/'.$category->id : 'admin/data/prompt-categories/create']) !!}
