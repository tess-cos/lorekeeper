...
<div class="navimg"></div><br /><div class="navimgbg">.<br />.<br /></div><br />
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            @endforeach
            <li class="nav-item mbg"><a role="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><span class="fas fa-briefcase" data-toggle="tooltip" title="Check All Currencies" style="color: #95b582; margin-top: 9px; font-size: 13pt; margin-left: 2.5px; margin-right: 2.5px; padding-top: 2.5px; padding-bottom: 2.5px; padding-left: 3px;"></span></a></li>
            <div class="collapse" id="collapseExample" style="height: inherit; position: absolute; z-index: 3; top: 100%; max-width: auto; background-color: #fafafa; margin: auto; padding: 10px; border-radius: 2.5px;">@foreach(Auth::user()->getCurrencies(true) as $currency)<span style="color: #4A4A4A; margin-top: 5px; margin-left: 0.5px; padding: 2.5px;"> {!! $currency->display($currency->quantity) !!}</span>@endforeach</div>
            <li class="nav-item dropdown">
