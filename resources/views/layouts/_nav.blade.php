...
<div class="navimg"></div><br /><div class="navimgbg">.<br />.<br /></div><br />
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="collapse" id="collapseExample" style="height: inherit; position: absolute; z-index: 3; top: 100%; max-width: auto; background-color: #fafafa; margin: auto; padding: 10px; border-radius: 2.5px;">@foreach(Auth::user()->getCurrencies(true) as $currency)<span style="color: #4A4A4A; margin-top: 5px; margin-left: 2.5px; padding: 2.5px;"> {!! $currency->display($currency->quantity) !!}</span>@endforeach</div>
            <li class="nav-item dropdown">
