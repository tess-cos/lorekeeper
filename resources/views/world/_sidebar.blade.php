<ul><div class="sideimg"></div>
    <li class="sidebar-header"><a href="{{ url('world') }}" class="card-link">Glossary</a></li>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item" style="display: none;"><a href="{{ url('world/collections') }}" class="{{ set_active('world/collections*') }}">Collections</a></div>
        <div class="sidebar-item" style="display: none;"><a href="{{ url('world/collection-categories') }}" class="{{ set_active('world/collection-categories*') }}">Collection Categories</a></div>
    </li>
    <li class="sidebar-section">
