<div class="card mb-3">
    <div class="card-header" style="border-bottom: 0px;">
        <h2 class="card-title mb-0"><i class="fas fa-seedling ct-2" style="color: #95b582;"></i> {!! $news->displayName !!}</h2>
        <small>
    ...
    @if(!$page)
        <div class="text-right mb-2 mr-2">
            <a class="btn bb ct-1" href="{{ $news->url }}" style="background-color: #f9f8f3; border-radius: 15px; text-transform: lowercase;"><i class="fas fa-comment"></i> {{ $commentCount }} Comment{{ $commentCount != 1 ? 's' : ''}}</a>
        </div>
    @else
        <div class="text-right mb-2 mr-2">
