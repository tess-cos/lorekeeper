...
<ul><div class="sideimg"></div>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $user->url.'/shops' }}" class="{{ set_active('user/'.$user->name.'/shops*') }}">User Shop</a></div>
    ...
    <li class="sidebar-section" style="border-bottom-left-radius: .50rem; border-bottom-right-radius: .50rem; padding-bottom: 10px;">
        ...
        <div class="sidebar-item" style="display: none;"><a href="{{ $user->url.'/collection-logs' }}" class="{{ set_active($user->url.'/collection-logs*') }}">Collection Logs</a></div>
