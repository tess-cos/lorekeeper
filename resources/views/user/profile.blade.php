...
@endif
<h1>
    <img src="/images/avatars/{{ $user->avatar }}" style="width:125px; height:125px; float:left; border-radius:50%; margin-left: 20px; margin-right:25px; margin-top: -10px; margin-bottom: 20px; padding: 5px;" alt="{{ $user->name }}" >
    {!! $user->displayName !!}
