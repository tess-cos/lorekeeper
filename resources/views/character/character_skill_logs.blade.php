...
<div class="row ml-md-2 mb-4">
  <div class="d-flex row flex-wrap col-12 mt-1 pt-1 px-0 ubt-bottom">
    <div class="col-4 col-md-2 font-weight-bold">Awarded By</div>
    <div class="col-4 col-md-4 font-weight-bold">Log</div>
    <div class="col-4 col-md-4 font-weight-bold">Quantity</div>
    <div class="col-4 col-md-2 font-weight-bold">Date</div>
  </div>
  @foreach($logs as $log)
      @include('character._character_skill_log_row', ['log' => $log, 'character' => $character])
  @endforeach
