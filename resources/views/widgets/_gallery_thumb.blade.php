@if(isset($submission->content_warning))
    <img class="img-thumbnail" style="background: #fff; border: 1px solid #f4e3e6; padding: 5px;" src="{{ asset('/images/content_warning.png') }}" alt="Content Warning"/>
@elseif(isset($submission->hash))
    <img class="img-thumbnail" style="background: #fff; border: 1px solid #f4e3e6; padding: 5px;" src="{{ $submission->thumbnailUrl }}" alt="Submission thumbnail"/>
@else
