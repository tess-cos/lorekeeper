                                ...
                                @case('MultiPet')
                                    <div class="multi-pet-select-group">
                                        <div class="multi-pet-list">
                                            @foreach ($ingredient->data as $entry)
                                                <div class="mb-2">
                                                    {!! Form::select('ingredient_data[' . $row_counter . '][]', $pets, $entry, ['class' => 'form-control pet-select selectize', 'placeholder' => 'Select Pet']) !!}
                                                    <div class="text-right text-uppercase" style="margin-top: -0.5em;"><a href="#" class="remove-multi-entry-button text-danger {{ count($ingredient->data) > 1 ? '' : 'hide' }}">Remove Pet</a></div>
                                                </div>
                                            @endforeach
                                        </div>
