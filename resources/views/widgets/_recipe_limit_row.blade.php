<div id="limitRowData" class="hide">
    <table class="table table-sm">
        <tbody id="limitRow">
            <tr class="limit-row">
                <td>{!! Form::select('limit_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'Recipe' => 'Spell'], null, ['class' => 'form-control reward-type', 'placeholder' => 'Select limit Type']) !!}</td>
    ...
    {!! Form::select('limit_id[]', $recipes, null, ['class' => 'form-control recipe-select', 'placeholder' => 'Select Spell']) !!}
</div>