    ...
    <tbody id="rewardTableBody">
        @if($rewards)
            @foreach($rewards as $reward)
                <tr class="reward-row">
                    <td>{!! Form::select('rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Raffle' => 'Raffle', 'Pet' => 'Pet'], $reward->rewardable_type, [
                    ...
                    <td class="reward-row-select">
                        ...
                        @elseif($reward->rewardable_type == 'Pet')
                            {!! Form::select('rewardable_id[]', $pets, $reward->rewardable_id, ['class' => 'form-control raffle-select selectize', 'placeholder' => 'Select Raffle']) !!}
                        @endif
                    </td>
