...
return [
    ...
    */
    ...
    |
    */
    'site_desc' => 'Cossetlings: Closed Species & ARPG',
    ...
    */
    ...
    'terms_popup' => [
        ...
        "text" => "You must be 18+ to access this site. By clicking 'Accept', you are confirming to be 18 years or older and to follow the json_encode([
